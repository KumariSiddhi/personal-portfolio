...
const About = () => {
  const [resumeLink] = useState("https://drive.google.com/file/d/18kDJm1dmmCvk2rVRw_TX8sjIXuy6HeeE/view?usp=sharing");
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 lg:pr-16 md:pr-8 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="leading-relaxed text-justify mb-8 max-w-lg mx-auto md:mx-0">
            I am Siddhi Singh, a final year Civil Engineering student at NIT Silchar, originally from Sitamarhi, Bihar, with roots in the mighty Magadh Empire Dynasty. I have a passion for full-stack development, specializing in React JS, Next JS, SQL, Node JS, and MongoDB. 
            <br /><br />
            Currently, I am a Core Member of the Google Developers Student Club and have a strong background in hackathons and project management. My journey includes participating in hackathons like Adobe Hackathon, Flipkart Grid 7.0, and organizing technical events on campus. 
